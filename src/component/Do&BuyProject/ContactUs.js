...
import solar from './coverimage/cover3.jpg'
        ...
        <div className="relative px-4 py-8  overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <p className="text-center font-extrabold text-6xl text-amber-300 ">Suncraft </p>
        
            </div>
            <div className="w-full max-w-xl  xl:w-8/14 ">
              <div className="bg-green-500 rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button type="submit" className="btn w-full btn-outline text-black ring-offset-2 ring-4">
                      Send Your Mail
                    </button>
                  </div>
